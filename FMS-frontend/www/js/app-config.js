...
{
  var db = openDatabase('fms', '1.0', 'Test DB1', 5* 1024 * 1024);
  ...
  db.transaction(function(tx){
    tx.executeSql('CREATE TABLE IF NOT EXISTS fms (empId,location,Punctuality,Ambiance,Behaviour,Skill,Safety,water,comments,submitDate)',[],createSuccess,onError);
